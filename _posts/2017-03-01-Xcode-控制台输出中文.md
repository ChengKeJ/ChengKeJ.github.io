...
创建一个字典并输出:
    ...
    NSMutableSet *set = [NSMutableSet setWithArray:@[@"set0",
                                                     strData,
                                                     dicData]];
    NSDictionary *dic = @{@"name"  : @"小技术君",
                           @"My bolg" : @"http://ChengKeJ.github.io",
                           @"count" : @(11),
                           @"strData" : strData,
                           @"dicData" : dicData,
                           @"set"     : set,
                           @"Unicode" : @"😀😁🤣😂😄",
                           @"contact" : @[@"小技术君 Blog:http://ChengKeJ.github.io",
                                          @"GitHub:https://github.com/ChengKeJ",
                                          @"简书:https://http://www.jianshu.com/u/e71990ada2fd"]};
    NSLog(@"%@", dic);
   
输出结果：
	
	2017-03-01 10:36:45.709 小技术君FoundationLog_Demo[1657:53604] {
	    "My bolg" = "http://ChengKeJ.github.io";
	    Unicode = "\Ud83d\Ude00\Ud83d\Ude01\Ud83e\Udd23\Ud83d\Ude02\Ud83d\Ude04";
	    contact =     (
	        "小技术君 Blog:http://ChengKeJ.github.io",
	        "GitHub:https://github.com/ChengKeJ",
...
将`小技术君FoundationLog.m`拖入项目，再次运行

	2017-03-01 10:35:52.545 小技术君FoundationLog_Demo[1635:52772] 	{
		set = 	{(
			"str -> data格式的字符串",
			"set0",
				{
...
代码及Demo地址：[GitHub](https://github.com/ChengKeJ/小技术君FoundationLog)

## 使用方法

直接将 `小技术君FoundationLog.m` 文件拖入项目中就能使用
